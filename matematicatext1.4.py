        ...
        for caracteres in conta_usuario:
            ...
            if caracteres == '.':
                ...
                if caracteres == '-' and self.identificador_numero_caractere == 0:
                    ...
                    if caracteres == '-' and conta_usuario[self.identificador_numero_caractere-1] == ' ':
                        if conta_usuario[self.identificador_numero_caractere-2] in self.identificador_de_sinais:
                            self.conta_usuario_separado.append(caracteres)
